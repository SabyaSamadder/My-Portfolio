        ...
        <main className="bg-blue-100 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-blue-100 rounded-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-white bg-opacity-75 rounded p-12">
                            <h1 className="mytext text-2xl lg:text-4xl mb-4">
                                {singleProject.title}
                            </h1>
                            <div className="flex justify-center text-gray-800">
                                ...
                                <p className="mytext flex items-center pl-2 text-xl">
                                    {singleProject.name}
                                </p>
                            </div>
                        </div>
                ...
                <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full">
                    <BlockContent blocks={singleProject.body} projectId="4r4yxplo" dataset="production"/>
                </div>
            </article>
        </main>
    );
